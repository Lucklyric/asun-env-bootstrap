...
beautiful.init(os.getenv("HOME") .. "/.config/awesome/themes/aug/theme.lua")
...
local menu_myquick = { "myquick", myquick}
local menu_terminal = { "open terminal", terminal }

if has_fdo then
    mymainmenu = freedesktop.menu.build({
        before = { menu_awesome , menu_myquick},
        after =  { menu_terminal }
    })
else
...
awful.screen.connect_for_each_screen(function(s)
    -- Wallpaper
    set_wallpaper(s)
    -- gears.wallpaper.maximized(os.getenv("HOME")..'/.config/awesome/bg/sd1Ky.jpg', s)
...
awful.rules.rules = {
    ...
    { rule = { },
     ...
     {rule= {class = "Gnome-terminal"},properties={opacity=0.75}},
    },
